...
public class C05Switch {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Lutfen 0-4 arasi bir puan giriniz");
        double puan = input.nextDouble();
        String seviye = "";// if-els in dışında kullanabilmek için seviyeyi if-els ten önce olusturuyoruz
        ...
        switch (seviye){
            ...
            default:
                System.out.println("Puaninizi dogru giriniz");
